...
library(RCurl)
script <- getURL("https://raw.githubusercontent.com/XpansivHQ/data-analytics/master/BP/River%20Birch/River%20Birch%20R%20Directories/Scripts%20and%20Functions/BP%20Projection%20Functions%20v5.R?token=Akc-RtSZ2hEXa3Deq9xQZWVuoU-PcUm7ks5a6LIiwA%3D%3D", ssl.verifypeer = FALSE)
